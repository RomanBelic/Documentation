...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 30 Décembre 2015 à 01:23
...
CREATE TABLE IF NOT EXISTS `associationdescription` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `idPresident_2` (`idPresident`),
  KEY `id_2` (`id`),
...
(1, '2015-12-16', 'test event', 'desc event', 5, 1);
...
(1, 1, '2015-12-17', NULL, '', 0, 1),
(2, 1, '2015-12-23', NULL, '', 0, 2),
(3, 3, '2015-12-23', NULL, '', 0, 1);
